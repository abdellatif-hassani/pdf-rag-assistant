    ...
    def query(self, question: str) -> Dict[str, Any]:
        ...
        try:
            with get_openai_callback() as cb:
                ...
                # Create prompt with specific format instructions
                prompt = ChatPromptTemplate.from_messages([
                    ("system", self.system_message),
                    ("system", """
                    IMPORTANT FORMATTING INSTRUCTIONS:
                    1. Provide ONLY the specific information requested
                    2. Use bullet points for lists
                    3. Include ONLY the fields mentioned in the question
                    4. Keep the response as concise as possible
                    5. Do not add any explanatory text or additional context
                    """),
                    ("user", """
                    Context: {context}
                    ...
                    Provide a concise answer with only the requested information.
                    """)
                ])
